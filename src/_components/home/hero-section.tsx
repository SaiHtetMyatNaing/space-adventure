...
const HeroSection = () => {
  return (
    <>
      ...
      <div className="flex flex-col gap-4 max-w-2xl w-full justify-start items-start">
      ...
      <Link
        href="/"
        className="w-64 h-64 rounded-full flex items-center justify-center bg-white text-lg"
      >
